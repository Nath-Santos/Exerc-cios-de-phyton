...
cod_combustivel = str(input())

if cod_combustivel == "Alcool":
   cod_combustivel = "A"

else:    
if cod_combustivel == "Gasolina":
   cod_combustivel = "G"
   
if quant_litros > 20 and cod_combustivel == "A":
   pag_preco_final = (quant_litros * 2.90) - ((5 / 100) * cod_combustivel)
elif quant_litros > 20 and cod_combustivel == "G":
   ...
   pag_preco_final = (quant_litros * 2.90) - ((3 / 100) * quant_litros)
    ...
    if quant_litros <= 20 and cod_combustivel == "G":
